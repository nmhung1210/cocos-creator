/****************************************************************************
 ...
 THE SOFTWARE.
 ****************************************************************************/
var fs = __globalAdapter.getFileSystemManager ? __globalAdapter.getFileSystemManager() : null;
...
var fsUtils = {
    ...
    getUserDataPath() {
        return __globalAdapter.env.USER_DATA_PATH;
    },
    ...
    downloadFile(remoteUrl, filePath, header, onProgress, onComplete) {
        ...
        var task = __globalAdapter.downloadFile(options);
    ...
    loadSubpackage(name, onProgress, onComplete) {
        var task = __globalAdapter.loadSubpackage({
            subpackage: name,
            success: function () {
